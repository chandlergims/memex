  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col items-center mb-6">
        ...
        <span className="text-sm text-center text-gray-500">Index Image (Max 5MB)</span>
      ...
      <div className="space-y-2">
        ...
        <input
          ...
          placeholder="Enter Index name (max 10 chars)"
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          ...
          <input
            ...
            placeholder="The greatest Index ever created (max 20 chars)"
